        ...
        <div class="row">
            <div class="col-sm-3"><!--left col-->
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item text-right"><span class="pull-left"><strong>Profile Views</strong></span> 0</li>
            ...
            <div class="col-sm-9">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        ...
                        {!! Form::open(['method'=>'POST','action'=>'UserPartnerController@store','files'=>'true']) !!}
                        <div class="row">
