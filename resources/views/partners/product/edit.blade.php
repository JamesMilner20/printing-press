...
{{--                                <img src="{{$product->photo?$product->photo->file:'No Image'}}" alt="" class="img-responsive img-rounded">--}}
                            ...
                            <div class="col-md-6">
                                {!! Form::model($product,['method'=>'PATCH','action'=>['PartnerPostsController@update', $product->id],'files'=>'true']) !!}
                                ...
                                {!! Form::open(['method'=>'DELETE', 'class'=>'col-6', 'action'=>['PartnerPostsController@destroy', $product->id]]) !!}
