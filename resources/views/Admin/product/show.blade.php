                    ...
                    <div class="product-details">
                        ...
                        <div class="product-meta">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item"><i class="fa fa-folder-open-o"></i> Category<a href=""></a></li>
                        ...
                        <div class="product-slider">
                            @foreach($product->images as $image)
                                <div class="product-slider-item my-4" data-image="images/products/products-1.jpg">
                                    <img height="100" class="img-fluid w-100" src="{{'/images/'.$image->name}}" alt="product-img">
                                </div>
