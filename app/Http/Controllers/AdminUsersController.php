...
class AdminUsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.users.index', compact('users','products','join'));
...
//        $category = DB::table('categories')->where('id',$number)->first();
        ...
        return view('admin.users.show',compact('user','join'));
    ...
    public function edit($id)
    {
        ...
        return view('admin.users.edit', compact('user','roles','join'));
